      ...
      <div>
              ...
              <div className="header-block">
                  <div className="header-info">
                      ...
                      <button className="header-info-button">
                          <img className="button-icon" src="../src/icons/menus 1.svg" alt=""/>
                  ...
                  <div>
                      <img src="../src/icons/search-header.svg" alt=""/>
                  </div>
              </div>
              ...
              <div className="section1-block1">
                  <div className="section1-info1">
                      <div className="section1-icon-block">
                          <img src="../src/icons/trophy (1) 1.svg" alt=""/>
                      </div>
                  ...
                  <div className="section1-info2">
                      <div className="section1-icon-block">
                          <img src="../src/icons/star 1.svg" alt=""/>
                      </div>
                      <div className='div-mr-l20'>
                  ...
                  <div className="section1-info3">
                      <div className="section1-icon-block">
                          <img src="../src/icons/Layer_1.svg" alt=""/>
                      </div>
                      <div className='div-mr-l20'>
              ...
              <div className="section1-block2">
                  ...
                  <div className="section1-body">
                      <div className="section1-content1">
                          <div className="section1-content1-head">
                              <div className="section1-content1-head-block">
                                  <img className="section1-content1-head-icon" src="../src/icons/shopping-bag 2.svg" alt=""/>
                              </div>
                      ...
                      <div className="section1-content1">
                          <div className="section1-content1-head">
                              <div className="section1-content1-head-block">
                                  <img className="section1-content1-head-icon" src="../src/icons/checklist 2.svg" alt=""/>
                              </div>
                      ...
                      <div className="section1-content1">
                          <div className="section1-content1-head">
                              <div className="section1-content1-head-block">
                                  <img className="section1-content1-head-icon" src="../src/icons/stethoscope 1.svg" alt=""/>
                              </div>
                      ...
                      <div className="section1-content1">
                          <div className="section1-content1-head">
                              <div className="section1-content1-head-block">
                                  <img className="section1-content1-head-icon" src="../src/icons/location 1.svg" alt=""/>
                              </div>
                      ...
                      <div className="section1-content1">
                          <div className="section1-content1-head">
                              ...
                              <div className="section1-content1-head-block">
                                  <img className="section1-content1-head-icon" src="../src/icons/picture 1.svg" alt=""/>
                              </div>
          ...
          <div className="botton">
              <div className="botton-block1">
                  <img src="../src/icons/logo-black.svg" alt=""/>
                  ...
                  <div className="botton-block2">
                      ...
                      <div className="botton-block3">
                          ...
                          <div className="botton-block-icon">
                              <div>
                                  <img src="../src/icons/whatsapp (1) 2.svg" alt=""/>
                              </div>

                              <div>
                                  <img src="../src/icons/vk-social-network-logo 1.svg" alt=""/>

                              </div>
                              <div>
                                  <img src="../src/icons/telegram 1.svg" alt=""/>
                              </div>
          ...
          <div className="down">
              ...
              <div className="down-block2">
                  ...
                  <div><img src="../src/icons/logo-down.svg" alt=""/></div>
